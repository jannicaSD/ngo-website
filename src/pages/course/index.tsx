...
export default function Course() {
  ...
  return (
    <>
      <Navbar />
      <main className="bg-white text-gray-900 min-h-screen font-sans selection:bg-emerald-600 selection:text-white relative overflow-hidden">
        ...
        {/* --- HERO SECTION --- */}
        <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 px-4 sm:px-6 lg:px-8 border-b border-gray-100">
          <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold uppercase tracking-wider border border-emerald-200/60 shadow-sm">
              <Sparkles size={13} className="text-emerald-600" /> Bible & Leadership Institute
            </div>
            ...
            <p className="text-xs sm:text-sm text-emerald-800/80 italic max-w-xl mx-auto pt-1">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4">
              <a 
                href="#learning-areas" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-emerald-700 text-white px-7 py-3.5 rounded-xl font-semibold hover:bg-emerald-800 transition-all shadow-md shadow-emerald-700/20 group active:scale-95 text-sm"
              >
              ...
              <a 
                href="#register" 
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-gray-50 text-gray-700 border border-gray-200 px-7 py-3.5 rounded-xl font-semibold hover:bg-gray-100 hover:border-gray-300 transition-all active:scale-95 text-sm"
              >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {learningApproach.map((item, i) => (
                <div 
                  key={i} 
                  className="bg-white border border-gray-200/80 p-7 rounded-2xl hover:border-emerald-500/50 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group flex flex-col justify-between"
                >
                  <div>
        ...
        <section id="learning-areas" className="py-20 px-4 sm:px-6 lg:px-8 border-y border-gray-100 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {learningAreas.map((area, i) => (
                <div 
                  key={i} 
                  className="bg-white border border-gray-200/80 rounded-2xl p-7 flex flex-col justify-between shadow-sm hover:border-emerald-500/50 hover:shadow-lg transition-all"
                >
                  <div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {objectives.map((obj, i) => (
                <div 
                  key={i} 
                  className="bg-white border border-gray-200/80 p-6 rounded-xl flex items-start gap-4 hover:border-emerald-500/40 hover:shadow-md transition-all"
                >
        ...
        {/* --- WHO CAN JOIN? --- */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-y border-gray-100 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {audience.map((aud, i) => (
                <div 
                  key={i} 
                  className="bg-white border border-gray-200/80 p-7 rounded-2xl text-center hover:border-emerald-500/50 hover:shadow-lg transition-all group"
                >
        ...
        {/* --- CALL TO ACTION (CTA) --- */}
        <section id="register" className="py-24 px-4 sm:px-6 lg:px-8 text-center bg-gray-50/50">
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-emerald-900 via-teal-900 to-gray-900 text-white rounded-3xl p-8 sm:p-12 md:p-16 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3.5">
                <a 
                  href="#learning-areas" 
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-emerald-500 text-white px-7 py-3.5 rounded-xl font-semibold hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-900/40 active:scale-95 text-sm"
                >
                  📖 Explore Learning Areas
                </a>
                <a 
                  href="mailto:contact@parakletus.org" 
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/10 text-white border border-white/20 px-7 py-3.5 rounded-xl font-semibold hover:bg-white/20 transition-all active:scale-95 backdrop-blur-md text-sm"
                >
                  📩 Register Interest
                </a>
              </div>
